        ...
        <div class="hero__slider js-slider">
            <div class="hero-slide">
                <div class="hero-slide-image lazy"
                     style="background-image: url('$resourceURL('themes/sample-site/static/images/cms/slider.jpg')');"
                     data-src="$resourceURL('themes/sample-site/static/images/cms/slider.jpg')">
                </div>
                <div class=" grid-x align-center hero-slide-content">
                    <div class="grid-container">
                        <div class="small-10 small-offset-1">
                            <%--<h3 class='h1'>Gift & Celebrations</h3>--%>
                        </div>
                    </div>
                </div>
            </div>
            <div class="hero-slide">
                <div class="hero-slide-image lazy"
                     style="background-image: url('$resourceURL('themes/sample-site/static/images/cms/wedding slider.jpg')');"
                     data-src="$resourceURL('themes/sample-site/static/images/cms/wedding slider.jpg')">
                </div>
            ...
            <div class="hero-slide">
                <div class="hero-slide-image lazy"
                     style="background-image: url('$resourceURL('themes/sample-site/static/images/cms/gf.jpg')');"
                     data-src="$resourceURL('themes/sample-site/static/images/cms/gf.jpg')">
                </div>
                <div class="text-center hero-slide-content">
                    <div class="grid-container">
                        <div class="small-10 small-offset-1">
                            <h2 class='fs'>Flower Store</h2>
                        </div>
                    </div>
                </div>
            </div>
            <div class="hero-slide">
                <div class="hero-slide-image lazy"
                     style="background-image: url('$resourceURL('themes/sample-site/static/images/cms/s3.jpg')');"
                     data-src="$resourceURL('themes/sample-site/static/images/cms/s2.jpg')">
                </div>
                <div class="text-center hero-slide-content">
                    <div class="grid-container">
                        <div class="small-10 small-offset-1">
                            <h2 class='gc'>Gift & Celebrations</h2>
                        </div>
                    </div>
                </div>
            </div>
